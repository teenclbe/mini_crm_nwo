...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-5">
        <h1 class="text-2xl font-bold mb-5">Add New Room</h1>
        @if ($errors->any())
        ...
        <form action="{{ route('rooms.store') }}" method="POST" class="max-w-lg">
            ...
            <div class="mb-4">
                ...
                <textarea type="text" name="description" class="mt-1 p-2 w-full border rounded" required></textarea>
            </div>
            <div class="mb-4">
                <label for="price_per_hour" class="block text-sm font-medium text-gray-700">Price per Hour</label>
                <input type="number" name="price_per_hour" step="0.01" class="mt-1 p-2 w-full border rounded" required>
            </div>
            <div class="mb-4">
                <label for="capacity" class="block text-sm font-medium text-gray-700">Capacity</label>
                <input type="number" name="capacity" class="mt-1 p-2 w-full border rounded" required>
            </div>
